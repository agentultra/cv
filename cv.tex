...
\section{Languages}
\cvitemwithcomment{Javascript}{Expert}{Advanced knowledge of data
  structures, run time internals of various engines, tooling, and
  libraries. Have given beginner and advanced talks on functional
...
\cvitemwithcomment{Python}{Expert}{Advanced knowledge of AST,
  ...
  Programming in Python} by Pakt Publishing \link{http://bit.ly/1s0Z7sU}.}
\cvitemwithcomment{C}{Advanced}{Familiar with C89, C99, and modern tools and
  ...
  applications.}
\cvitemwithcomment{Haskell}{Intermediate}{Completed a course from the University
  of Glasgow on Haskell in 2017. Experience with writing event-sourced
  applications, GraphQL, Postgresql, WebSockets.}
...
\section{Tools}
\cvdoubleitem{RDBMS}{PostgreSQL, MySQL}{Web Servers}{Ngninx}
\cvdoubleitem{NoSQL}{Redis}{Web}{Warp, Yesod, Express}
\cvdoubleitem{Networking}{eventlet, NodeJS, conduit}{Cloud}{Cinder,
  Nova, Tempest, Swift, Neutron, Astara}
