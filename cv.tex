...
\cvitem{Technical Skills}{I have recent experience in high-volume, critical card authorization and transaction processing, distributed systems, and back-end web application architecture in both the control and data plane.}
