...
\address{133 Queen St. S}{L8P-3S3 Hamilton, ON}    % optional, remove /
                                % comment the line if not wanted
...
\cvitem{}{I have been interested in developing programming
  ...
  guarantees.}
\cvitem{}{\emph{Game Design}}
\cvitem{}{Games have been a central part of my life ever since my
  first Amiga 500. Since then I've become a prolific board gamer, RPG
  enthusiast and designer. I've developed my own RPG supplement for
  games masters at http://dungeonmastersdelight.com and am interested
  in pursuing research in developing web-based game development
  environments, grand-strategy games and story-based games.}
...
\cventry{2013}{Senior Developer}{SwiftStack}{Remote}{}{Contributor to
  core Swift control panel, web services and Swift code
  reviews.\newline{}%
Detailed achievements:%
\begin{itemize}%
\item Implemented distributed process co-ordination for healthcheck
  alerting
\item Systematically improved code quality
\item Designed and implemented key features of main website
\end{itemize}}
\cventry{2012-2013}{Senior Developer}{Internap Network
...
\cvitem{Board games}{I'm a huge gaming nerd and I have a collection of
  30+ board games.}
\cvitem{Rock Climbing}{I'm hoping to hit the Chief in 2014}
\cvitem{Running}{I've ran the Warrior Dash 2011 and Spartan Sprint
  2012}
