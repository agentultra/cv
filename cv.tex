...
\section{Summary}
\cvitem{Experience}{Over twenty years in software development, design, leadership and management roles. Maintain several open source libraries and projects.}
\cvitem{Technical Skills}{Recent experience in high-volume, critical online transaction processing, distributed systems, and back-end web application architecture in both the control and data plane.}
