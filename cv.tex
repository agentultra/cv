...
\cvitemwithcomment{Haskell}{Beginner}{Completed a course from the University
  of Glasgow on Haskell in 2017. Currently using Haskell in a side-project to
  develop a secure-by-default mail transfer agent.}
\cvitemwithcomment{OCaml}{Beginner}{Completed a course from INRIA in 2016.
  Have used OCaml to learn about MirageOS, Bucklescript, and functional
  programming.}

\section{Tools}
\cvdoubleitem{RDBMS}{PostgreSQL, MySQL}{Web Servers}{Ngninx}
\cvdoubleitem{NoSQL}{Redis}{Web}{Django, Flask, Restify, Express}
\cvdoubleitem{Networking}{Twisted, Tornado, eventlet, NodeJS}{Cloud}{Cinder, Nova,
...
{Various duties:
  ...
  \item Led the design, specification, and development of core products
