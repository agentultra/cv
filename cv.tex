...
\section{Summary}
\cvitem{Experience}{I have over ten years in software development, design, leadership and management roles. I maintain several open source libraries and projects.}
\cvitem{Technical Skills}{High availability and reliability systems, distributed systems, and back-end web application architecture in both the control and data plane.}
...
\cvitemwithcomment{Javascript}{Expert}{Led the design and development
  of large scale applications both in NodeJS and in the browser with
...
\cvitemwithcomment{Haskell}{Expert}{Have used the language on a 1M+
  ...
  source libraries. Regularly stream myself working on various Haskell
  projects.}
...
\cvdoubleitem{Architectures}{CRUD, MVC, Event Sourcing, SOA}{Web}{Warp, Yesod, Express, Django, React}
...
{\begin{itemize}%
  \item Designed and implemented critical, performance-sensitive
    Online Transaction Processing and authorization system for card
    transactions; one the most profitable sources of revenue for the
    company.
  ...
  \item Established cross-functional working groups to share knowledge
    ...
    other teams such as real-time threat and fraud modelling systems.
  \item Demonstrated product and systems thinking by designing tools
    ...
    satisfaction.
  \item Contributed front-end changes in Typescript and React to
    provide effective workflows for administrative users.
\end{itemize}}
...
\end{itemize}}
\cventry{2014-2016}{Cloud Consultant}{Dreamhost}{Remote}{}{
\begin{itemize}%
...
\end{itemize}}
\cventry{2012}{Contract Developer}{Internap Network
  Services}{Remote}{}{
\begin{itemize}
...
\item Scaled web application up to millions of unique impressions
  every month
\item Implemented search engine solution that crawled through millions
  of images and related metadata
\end{itemize}}
