...
\cvitem{}{\emph{Software Engineering}} \cvitem{}{I am interested and captivated
  by what software development could learn from engineering disciplines. I
  believe software doesn't need to be safety-critical in order to cause harm
  and that the cost of writing correct and reliable software is becoming
  manageable for more kinds of projects every day. I'm inspired by formal
  methods, functional programming, and specification driven development.}
...
\cvdoubleitem{NoSQL}{Redis}{Web}{Warp, Scotty, Express}
...
\cventry{2016-Present}{Software Engineering Manager}{Weever Apps}{}{}
{Various duties:
  \begin{itemize}%
  ...
  \item Led the design, specification, and development of core
    products using Haskell and Javascript
...
\cvitem{Woodworking}{I also like to carve wood with hand-tools.}
